...
output_file = r"/Users/williammdavis/Repository/gwu-arl-data-pt-06-2020-u-c/02-Homework/03-Python/Instructions/PyBank/Resources/budget_analysis.txt"
...
results = (
    ...
    f"Greatest Decrease: {greates_decrease}\n"
)
print(results)
